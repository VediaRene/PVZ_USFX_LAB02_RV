...
{
	if (!Lodging) {
		UE_LOG(LogTemp, Error, TEXT("BuildSwimmingPool():
...
{
	if (!Lodging) {
		UE_LOG(LogTemp, Error, TEXT("BuildLobbyArea():
			Lodging is NULL, make sure it's initialized.")); return; }
...
{
	if (!Lodging) {
		UE_LOG(LogTemp, Error, TEXT("BuildRestaurants():
			Lodging is NULL, make sure it's initialized.")); return; }
...
{
	if (!Lodging) {
		UE_LOG(LogTemp, Error, TEXT("BuildRooms():
			Lodging is NULL, make sure it's initialized.")); return; }
