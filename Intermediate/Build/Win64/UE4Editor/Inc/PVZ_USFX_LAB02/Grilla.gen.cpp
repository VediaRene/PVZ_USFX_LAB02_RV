...
#include "PVZ_USFX_LAB02/Grilla.h"
#ifdef _MSC_VER
#pragma warning (push)
...
// Cross Module References
	PVZ_USFX_LAB02_API UEnum* Z_Construct_UEnum_PVZ_USFX_LAB02_EHexTileType();
	UPackage* Z_Construct_UPackage__Script_PVZ_USFX_LAB02();
	PVZ_USFX_LAB02_API UClass* Z_Construct_UClass_AGrilla_NoRegister();
	PVZ_USFX_LAB02_API UClass* Z_Construct_UClass_AGrilla();
	ENGINE_API UClass* Z_Construct_UClass_AActor();
	ENGINE_API UClass* Z_Construct_UClass_UStaticMeshComponent_NoRegister();
	PVZ_USFX_LAB02_API UClass* Z_Construct_UClass_AGridaManager_NoRegister();
// End Cross Module References
	static UEnum* EHexTileType_StaticEnum()
	{
		...
		if (!Singleton)
		{
			Singleton = GetStaticEnum(Z_Construct_UEnum_PVZ_USFX_LAB02_EHexTileType, Z_Construct_UPackage__Script_PVZ_USFX_LAB02(), TEXT("EHexTileType"));
		}
		return Singleton;
	}
	...
	static FCompiledInDeferEnum Z_CompiledInDeferEnum_UEnum_EHexTileType(EHexTileType_StaticEnum, TEXT("/Script/PVZ_USFX_LAB02"), TEXT("EHexTileType"), false, nullptr, nullptr);
	uint32 Get_Z_Construct_UEnum_PVZ_USFX_LAB02_EHexTileType_Hash() { return 1518784438U; }
	UEnum* Z_Construct_UEnum_PVZ_USFX_LAB02_EHexTileType()
	{
#if WITH_HOT_RELOAD
		UPackage* Outer = Z_Construct_UPackage__Script_PVZ_USFX_LAB02();
		static UEnum* ReturnEnum = FindExistingEnumIfHotReloadOrDynamic(Outer, TEXT("EHexTileType"), 0, Get_Z_Construct_UEnum_PVZ_USFX_LAB02_EHexTileType_Hash(), false);
#else
...
#endif
	const UE4CodeGen_Private::FEnumPropertyParams Z_Construct_UClass_AGrilla_Statics::NewProp_TipoGrilla = { "TipoGrilla", nullptr, (EPropertyFlags)0x0020080000010015, UE4CodeGen_Private::EPropertyGenFlags::Enum, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(AGrilla, TipoGrilla), Z_Construct_UEnum_PVZ_USFX_LAB02_EHexTileType, METADATA_PARAMS(Z_Construct_UClass_AGrilla_Statics::NewProp_TipoGrilla_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_AGrilla_Statics::NewProp_TipoGrilla_MetaData)) };
#if WITH_METADATA
	...
	IMPLEMENT_CLASS(AGrilla, 454823939);
	template<> PVZ_USFX_LAB02_API UClass* StaticClass<AGrilla>()
	{
		return AGrilla::StaticClass();
	}
	static FCompiledInDefer Z_CompiledInDefer_UClass_AGrilla(Z_Construct_UClass_AGrilla, &AGrilla::StaticClass, TEXT("/Script/PVZ_USFX_LAB02"), TEXT("AGrilla"), false, nullptr, nullptr, nullptr);
